                      ...
                      <div className="text-center py-12">
                        ...
                        {!query && (
                          <div className="flex flex-wrap gap-1 justify-center">
                            <span className="inline-flex items-center px-2 py-1 text-xs font-medium bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-400">
                              "cryptocurrency"
                            </span>
                            <span className="inline-flex items-center px-2 py-1 text-xs font-medium bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-400">
                              "bitcoin"
                          ...
                          >
                            <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-700 px-6 py-4">
                              <div className="flex items-center gap-3">
                                ...
                                <div className="flex items-center gap-2">
                                  <div className="text-xs text-slate-500 bg-slate-200 dark:bg-slate-700 px-2 py-1 font-mono">
                                    {ev.id}
                                  </div>
                            ...
                            <div className="p-6 space-y-4">
                              ...
                              <div className="flex items-center gap-3 text-sm">
                                <div className="flex items-center gap-2">
                                  <div className="w-5 h-5 bg-slate-200 dark:bg-slate-700 flex items-center justify-center">
                                ...
                                <div>
                                  ...
                                  <div className="flex flex-wrap gap-1">
                                    {ev.tagBadges.map((tag) => (
                                      <span
                                        key={tag}
                                        className="inline-flex items-center bg-amber-100 dark:bg-amber-900/30 px-2 py-1 text-xs font-medium text-amber-700 dark:text-amber-300"
                                      >
                                        {tag}
                                      </span>
                                    ))}
